...
\author{EE22BTECH11023 - G.SAI HARSHITH}	
%\title{
...
\begin{align}
    ...
    \vec{C} = \myvec{-3\\-5}
\end{align}
In Problem, There is a theorem/law mentioned that thep points $\vec{A},\vec{B},\vec{C}$ are defined to be collinear if 
\begin{align}
    \text{rank}\myvec{
    1 & 1 & 1\\
    \vec{A} & \vec{B} & \vec{C} \\
...
\end{align}
There are no zero rows. Rank is 3\\
