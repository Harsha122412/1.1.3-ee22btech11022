...
(ii)$E$: no tail appears.\\
    $F$: no head appears.
\\ \solution
Sample space of the experiment may be described as
\begin{align}
S &= (HH,HT,TH,TT)
\end{align}
(i)
...
\begin{align}
F&=(HT,TH)
\label{eq:12.13.1.7,5}\\
P(F)&=\frac{2}{4}\\
&=\frac{1}{2}
\end{align}
From \eqref{eq:12.13.1.7,2} and \eqref{eq:12.13.1.7,5} we have
\begin{align}
EF&=(HT,TH)\\
P(EF)&=\frac{2}{4}\\
&=\frac{1}{2}\\
...
\begin{align}
E&=(HH)
\label{eq:12.13.1.7,14}\\
P(E)&=\frac{1}{4}
\end{align}
$F$: no head appears.
\begin{align}
F&=(TT)
\label{eq:12.13.1.7,16}\\
P(F)&=\frac{1}{4}
\end{align}
From \eqref{eq:12.13.1.7,14} and \eqref{eq:12.13.1.7,16} we have
\begin{align}
EF&=()\\
P(EF)&=\frac{0}{4}\\
&=0\\
